           ...
           <div class="block block-rounded">
               ...
               <div class="block-content block-content-full">
                 ...
                 <h1 class="flex-sm-fill h3 my-2">
                    Active Membership Enquiries<small class="d-block d-sm-inline-block mt-2 mt-sm-0 font-size-base font-w400 text-muted"></small>
                </h1>
                    <div class="col-sm-12">
                    ...
                    <tbody>
                        ...
                        <td class="font-w600 font-size-sm">
                            {{ $active_membership_enquiry->subject }}
                        </td>

                        @if ($banner->status == 1)
                          <td class="d-none d-sm-table-cell"><a href="{{ route('active_membership_enquiries.status', [$active_membership_enquiry->id]) }}"
