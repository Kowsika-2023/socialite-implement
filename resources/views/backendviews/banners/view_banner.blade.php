...
<main id="main-container">
  ...
  <div class="block block-rounded">
    <div class="block-header">
           ...
           <h3 class="block-title ">View Banner</h3>
        
         
      </div> 
       <div class="block-content block-content-full">
  
          <form action="{{ route('banners.show',$banner->id) }}" method="POST" >
              @csrf
...
<!-- Content input -->                    
                   ...
                   <div class="form-outline mb-4 col-8">
                             ...
                             <textarea  class="form-control @error('content') is-invalid @enderror"  name="content"  readonly  rows="4" cols="50" >{!! $banner->content !!}
                        </textarea>
                    </div> 
                                    ...
                                    <div class="row gutters-tiny items-push js-gallery push">
                                        <div class="animated fadeIn">
                                            <div class="options-container fx-item-rotate-r">
                                                <img src="{{ asset('images/banners/'.$banner->image) }}" readonly alt="your image" width="551px" height="368px" />
