           ...
           <div class="block block-rounded">
               ...
               <div class="block-content block-content-full">
                 ...
                 <h1 class="flex-sm-fill h3 my-2">
                    Active Service Enquiries<small class="d-block d-sm-inline-block mt-2 mt-sm-0 font-size-base font-w400 text-muted"></small>
                </h1>
                    <div class="col-sm-12">
                    ...
                    <tbody>
                        ...
                        @if ($active_service_enquiry->status == 1)
                          <td class="d-none d-sm-table-cell"><a href="{{ route('active_service_enquiries.status', [$active_service_enquiry->id]) }}"
                                  class="btn btn-success btn-sm">Read</a></td>
                      @else
                          <td class="d-none d-sm-table-cell"><a href="{{ route('active_service_enquiries.status', [$active_service_enquiry->id]) }}"
                                  class="btn btn-danger btn-sm">Not Read</a></td>
                      @endif
